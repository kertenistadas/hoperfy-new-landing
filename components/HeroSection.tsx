        ...
        <div id="signup">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 h-12 px-4 text-[14px] border border-[#e5e7eb] rounded-lg outline-none focus:border-[#1a6cf5] focus:ring-2 focus:ring-[#1a6cf5]/10 transition-all placeholder:text-[#9ca3af]"
            />
            <button
              onClick={() => setModalOpen(true)}
              className="h-12 px-6 text-[14px] font-medium bg-[#1a6cf5] text-white rounded-lg hover:bg-[#1558cc] transition-colors whitespace-nowrap"
            >
              Create my event →
            </button>
          </div>
